...
public class KafkaTopicsConfiguration {
    ...
    public final static String STOCK_QUOTES_TOPIC_NAME = "stock-quotes-oms";

    public final static String ADD_ORDER_TOPIC = "add-order-topic";
    ...
    @Bean
    @ConditionalOnProperty(name = "kafka.producer.enabled", havingValue = "true")
    public NewTopic addOrderTopic() {
        return TopicBuilder.name(ADD_ORDER_TOPIC)
                .build();
    }
}
